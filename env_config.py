...
ENV_KEYS = {
    ...
    "GOOGLEPLAY_CDP_ENDPOINT": "cdp_endpoint",
    "GOOGLEPLAY_PROXY": "proxy",
    "GOOGLEPLAY_URL": "url",
}
...
def unknown_keys(path=None):
    ...
    Usually a typo — `TWO_CAPTCHA_KEY`, `GOOGLEPLAY_CDP` — which otherwise fails
